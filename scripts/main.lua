...
local service = 5039;
local secret = "48ef5720-d0d7-443e-b96d-5b84b3bd7786";
local useNonce = true;
...
local KeySystemTab = Window:AddTab("Key System")
...
local WalkSpeedSlider = LeftGroupbox:AddSlider("WalkspeedSlider", {
    Text = "Walk Speed",
    Default = 16,
    Min = 1,
    Max = 100,
...
local JumpPowerSlider = LeftGroupbox:AddSlider("JumpPowerSlider", {
    Text = "Jump Power",
    Default = 50,
    Min = 10,
    Max = 200,
...
InfiniteJump = LeftGroupbox:AddToggle("InfiniteJump", {
    Text = "Infinite Jump",
    Default = false,
...
ToggleJump = LeftGroupbox:AddToggle("ToggleJump", {
    Text = "Jump Power",
    Default = false,
...
local KeyGroupbox = KeySystemTab:AddLeftGroupbox("Enter Key")

KeyGroupbox:AddLabel("Paste your key below to unlock Prism.")
...
KeyGroupbox:AddButton("Verify Key", function()
    ...
    if key and key ~= "" then
        ...
        if success then
            ...
            KeySystemTab.TabButton:Destroy()
            HomeTab:Show()
            LocalPlayerTab:Show()
        else
          currentKey = KeyInput
...
KeyGroupbox:AddButton("Copy Key Link", function()
    ...
    Library:Notify({
        Title = "Link Copied",
        Description = "The key system link was copied to your clipboard.",
        Time = 5
    })
end)
